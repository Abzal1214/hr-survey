...
const NewsHighlightSchema = new mongoose.Schema({
  ...
  title: String,
  description: String,
  theme: { type: String, default: 'sky' },
  items: [String],
  updatedAt: { type: Date, default: Date.now },
});

const HRTipSchema = new mongoose.Schema({
  icon: { type: String, default: '📋' },
  title: String,
  color: { type: String, default: 'from-slate-400 to-slate-600' },
  steps: [String],
  docs: [String],
...
const NotificationSchema = new mongoose.Schema({
  phone: String,         // recipient, empty = broadcast
  type: { type: String, default: 'info' }, // info | deadline | news
  title: String,
  body: String,
...
export const MentorNote = mongoose.models.MentorNote || mongoose.model('MentorNote', MentorNoteSchema);
export const MentorTask = mongoose.models.MentorTask || mongoose.model('MentorTask', MentorTaskSchema);
export const NewsHighlight = mongoose.models.NewsHighlight || mongoose.model('NewsHighlight', NewsHighlightSchema);
export const HRTip = mongoose.models.HRTip || mongoose.model('HRTip', HRTipSchema);
