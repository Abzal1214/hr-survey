...
export default function MentorsPage() {
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="rounded-xl bg-white/90 shadow p-10 text-center">
        <h1 className="text-3xl font-bold mb-4">Страница наставников</h1>
        <p className="text-slate-500">Здесь скоро появится список наставников и их задачи.</p>
      </div>
    </div>
  );
}
